...
public interface UserItemMapper {
    ...
    @Insert("insert into taiwan_cain_2nd.user_items(charac_no,slot,it_id,expire_date,obtain_from,reg_date,ipg_agency_no,ability_no,jewel_socket) values (#{characNo},#{slot},#{itemId},'9999-12-31 23:59:59',0,NOW(),concat('B11150101',lpad(concat('',#{characNo}),10,'0')),#{abilityNo},0x010000000000010000000000000000000000000000000000000000000000)")
